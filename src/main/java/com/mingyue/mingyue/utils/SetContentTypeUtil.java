...
public class SetContentTypeUtil {
    ...
    static {
        ...
        map.put("apk", "application/vndandroidpackage-archive");
        ...
        map.put("docx", "application/vndopenxmlformats-officedocumentwordprocessingmldocument");
        ...
        map.put("jad", "text/vndsunj2meapp-descriptor");
        ...
        map.put("mpc", "application/vndmpohuncertificate");
        ...
        map.put("mpn", "application/vndmophunapplication");
        ...
        map.put("msg", "application/vndms-outlook");
      ...
      map.put("ndb", "x-lml/x-ndb");
        ...
        map.put("nokia-op-logo", "image/vndnok-oplogo-color");
        ...
        map.put("pko", "application/yndms-pkipko");
        ...
        map.put("pptx", "application/vndopenxmlformats-officedocumentpresentationmlpresentation");
        ...
        map.put("r3t", "text/vndrn-realtext3d");
      ...
      map.put("rp", "image/vndrn-realpix");
        ...
        map.put("si7", "image/vndstiwapsis");

        map.put("si9", "image/vndlgtwapsis");

        map.put("sis", "application/vndsymbianinstall");
      ...
      map.put("thm", "application/vnderithm");
      ...
      map.put("wi", "image/wavelet");
        ...
        map.put("wmlscript", "text/vndwapwmlscript");
      ...
      map.put("wmz", "application/x-ms-wmz");
        ...
        map.put("ws", "text/vndwapwmlscript");

        map.put("wsc", "application/vndwapwmlscriptc");
        ...
        map.put("xar", "application/vndxara");
        ...
        map.put("xdw", "application/vndfujixeroxdocuworks");
        ...
        map.put("xla", "application/vndms-excel");
        ...
        map.put("xlsx", "application/vndopenxmlformats-officedocumentspreadsheetmlsheet");

        map.put("xlt", "application/vndms-excel");
